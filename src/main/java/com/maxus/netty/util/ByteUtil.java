...
public class ByteUtil {
    ...
    public static List<String> byteToBinarys(byte bytes[]) {
     ...
     * @return
     */
    public static String byteTo16Binary(int num) {
        String status1 = Integer.toBinaryString(num);
        int length = 16 - status1.length();
        for (int i = 0; i < length; i++)
            status1 = (new StringBuilder("0")).append(status1).toString();
     ...
     * @return
     */
    public static byte[] createDateTimeBytes(Date date){
        Calendar instance = Calendar.getInstance();
        instance.setTime(date);
        return createDateTimeBytes(instance);
    }
    ...
    private static int byte2int(byte res, byte res1) {
     ...
     * @return
     */
    public static String bytesToDateTimeStr(byte[] dataTimebytes) {
     ...
     * @return
     */
    public static Date bytesToDateTime(byte[] dataTimebytes) {
        Calendar dataTime = Calendar.getInstance();
        // 获取时间
        byte[] year = { 0x00, 0x00 };
        byte[] month = { 0x00 };
     ...
     * @return
     */
    public static byte[] bytesToGBDateTime(byte[] dataTimebytes) {
